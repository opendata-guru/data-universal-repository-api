<?php
	...
	if ('CKAN' === $link->system) {
		include 'live-systemchangelog/live-systemchangelog-ckan.php';
		liveSystemChangelogCKAN();
	} else if ('Piveau' === $link->system) {
		include 'live-systemchangelog/live-systemchangelog-piveau.php';
		liveSystemChangelogPiveau();
		...
		include 'live-systemchangelog/live-systemchangelog-opendatasoft.php';
		liveSystemChangelogOpendatasoft();
